<?php
	...
	$result = mysqli_query($con,"SELECT * FROM users WHERE username='$uname' AND password='$password' and type = 'recep' ");
	...
	if(mysqli_num_rows($result)){
		...
		echo $_SESSION['uname'];
		echo "<script> location.href='recephome.php'; </script>";
		exit;
	}
...
<body>
	...
	<br>
	<br>
	<form method="post" action="receplogin.php">
		<table align="center" cellpadding="10">
			<tr>

  	<div class="input-group">
  	  <td><label>Receptionist Username</label></td>
  	  <td><input type="text" id = 'uname1221' name="uname"></td>
  	</div>
  </tr>
  <tr>
	<div class="input-group">
  	  <td><label>Receptionist Password</label></td>
