...
<body>
	<a href="logout.php" style="float: right";><button id = 'logout1221' type="button">Log Out</button></a>
	<h3>ROOMS BOOKED:</h3>
	<br>
	<br>
	<br>
...
if (mysqli_num_rows($result) > 0) {
    ...
    while($row = mysqli_fetch_assoc($result)) {
    	$no=$row["room_no"];
        echo "<tr><td>" . $no . "</td><td>" . $row["room_type"]. "</td><td>" . $row["cost"]. "</td></tr>";
    }
   echo "</table>";
} else {
...
?> 
	...
	<a href="search_room.php"><button id = "back1221" type="button">Back to Home Page</button></a> 
</body>
</html>